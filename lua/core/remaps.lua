...
remapper.add_remap('n', '<leader>ff', builtin.find_files, { desc = 'Telescope find files' })
remapper.add_remap('n', '<leader>fg', builtin.git_files, { desc = 'Telescope git files' })
remapper.add_remap('n', '<leader>ps', function()
	builtin.grep_string({ search = vim.fn.input("Grep > ") });
end)
remapper.add_remap('n', '<leader>lg', builtin.live_grep, { desc = 'Telescope live grep' })
remapper.add_remap('n', '<leader>fs', builtin.lsp_workspace_symbols, { desc = 'Telescope workspace symbols' })
